...
| January 20, 2026   |  [Arthur Jaffe](https://www.physics.harvard.edu/people/facpages/jaffe) | Harvard University |  Some Fantastic Connections between Mathematics and Physics | <span class="abstract-link" onclick="showAbstract('Arthus-Jaffe')">View Abstract</span> |
| January 30, 2026 | [Luca Di Cerbo](https://people.clas.ufl.edu/ldicerbo/) |  University of Florida | Curvature, Macroscopic Dimensions, and Symmetric Product of Curves|  <span class="abstract-link" onclick="showAbstract('Luca-Di-Cerbo')">View Abstract</span>   |
...
| March 23, 2026  | [Assaf Naor](https://web.math.princeton.edu/~naor/)   | Princeton University |  Sparsest Cut   |  <span class="abstract-link" onclick="showAbstract('Assaf-Naor-I')">View Abstract</span>   |
...
Two smooth complex algebraic varieties might be algebraically isomorphic but not homeomorphic. Such examples can be obtained by changing the coefficients of the defining polynomials by some field automorphism of complex numbers. This field automorphism also provides an algebraic isomorphism from the Galois conjugate variety to the given variety by Galois conjugations on the complex solutions of the defining polynomials. Despite the highly discontinuity of this algebraic isomorphism, the theory of finite covering spaces (etale theory) indicates that it becomes a homotopy equivalence when profinite completing the varieties. In this talk, we will present how to understand this Galois symmetry on the underlying manifold structures of complex varieties in the following aspects. 1) Browder-Novikov-Sullivan-Wall's surgery theory provides invariants to characterize simply connected manifolds, which can be profinitely completed for the studies of varieties. 2) The Galois automorphism of a variety can be understood by the induced action on the stable tangent bundle, which turns out to be an abelian group action by restricting Galois automorphisms on roots of unity and agrees with the Adams operations. 3) The profinite completion of a complex variety provided by etale theory can be analogously extended to any combinatorial manifold by finite branched covering maps. 4) For any branched covering over a combinatorial manifold with a basepoint, a small loop circle around the branched locus once provided a permutation of the preimage of the basepoint. The collection of such permutations is defined to be the canonical permutation structure of the manifold. There is an obvious abelinized Galois action on such permutations by taking each cyclic sub-permutation to certain powers, which agrees with what Adams operations do to complex line bundles. This abelinized Galois action on permutation structures is what the actual Galois group does to change the combinatorial manifold geometry of a complex variety in its profinite homotopy equivalence type.
</div>
...
<div id="Arthur Jaffe" style="display:none;">
...
<div id="Luca-Di-Cerbo" style="display:none;">
...
<div id="Assaf-Naor-I" style="display:none;">
...
<div id="Assaf-Naor-II" style="display:none;">
...
<div id="Assaf-Naor-III" style="display:none;">
...
<div id="Dennis-Sullivan-I" style="display:none;">
...
<div id="Dennis-Sullivan-II" style="display:none;">
...
<div id="Dennis-Sullivan-III" style="display:none;">
